...
clf, clear, clc
tempo1(:,:,1) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_1990b1_236.tif');
tempo1(:,:,2) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_1990b2_236.tif');
tempo1(:,:,3) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_1990b3_236.tif');
tempo1(:,:,4) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_1990b4_236.tif');
tempo1(:,:,5) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_1990b5_236.tif');
tempo1(:,:,6) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_1990b7_236.tif');

tempo2(:,:,1) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_2011b1_236.tif');
tempo2(:,:,2) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_2011b2_236.tif');
tempo2(:,:,3) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_2011b3_236.tif');
tempo2(:,:,4) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_2011b4_236.tif');
tempo2(:,:,5) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_2011b5_236.tif');
tempo2(:,:,6) = imread('/Users/pma009/Documents/Pessoal/SurfaceReflectance/Ourilandia_236/clip/SR_2011b7_236.tif');

t1 = tempo1;%p1993;
t2 = tempo2;%p2014;
name = 'Workspace_Ourilandia_1990_2011_';
[Magnitude, Direcao]= magnitude(t1,t2,1990,2011);
% 
for i=1:size(Magnitude,1)
    for j=1:size(Magnitude,2)
        if Magnitude(i,j) > (1.8e+04)%erro de registro
            Magnitude(i,j) = 0;
            Direcao(i,j) = 90;
        end
    end
