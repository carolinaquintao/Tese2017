...
load('Workspace_SaoFelix_1990_1997.mat', 'tempo1')
load('Workspace_SaoFelix_1990_1997.mat', 'tempo2')
%%se tiver nuvem, tira antes
for i=1:6
    tempo1A = tempo1(:,:,i);
    tempo2A = tempo2(:,:,i);

    tempo1A(SaoFelix1990==-5555 | SaoFelix1997 == -5555) = -9999;
    tempo2A(SaoFelix1990==-5555 | SaoFelix1997 == -5555) = -9999;
    tempo1F(:,:,i) = tempo1A;
    tempo2F(:,:,i) = tempo2A;
end
clear tempo1 tempo1A tempo2 tempo2A
...
% imshow(pixel_labels,[])
%%
save('classificaSaoFelix_1997_2000')
%%
